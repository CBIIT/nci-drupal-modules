 ...
 * @file
 *
 * JavaScript functions for Bootstrap Site Alert module.
 */
...
(function ($) {
  Drupal.behaviors.bootstrapSiteAlert = {
    attach: function (context, settings) {
      ...
      var key = Drupal.settings.bootstrap_site_alert.key;
      ...
      $('.bs-site-alert .close').click(function(e) {
        ...
        $.cookie('Drupal.visitor.bootstrap_site_alert_dismissed', key, { path: Drupal.settings.basePath });
      });
    }
  }
})(jQuery);
