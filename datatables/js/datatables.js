      ...
      $.each(settings.datatables, function (selector) {
        $(selector, context).once('datatables', function() {
          ...
          if (settings.bExpandable) {
            ...
            nCloneTd.innerHTML = '<a href="#" class="datatables-expand datatables-closed dt_hide_details"></a>';
              ...
              $(this).click( function () {
                ...
                if (datatable.fnIsOpen(row)) {
                 ...
                 // $(this).html('Show Details');
                  $(this).removeClass('dt_show_details');
                  $(this).addClass('dt_hide_details');
                }
                else {
                  datatable.fnOpen( row, Drupal.theme('datatablesExpandableRow', datatable, row), 'details' );
                  //$(this).html('Hide Details');
                  $(this).removeClass('dt_hide_details');
                  $(this).addClass('dt_show_details');
                }
                return false;
              });
            });
