...
/**
 * @file
 * Hooks provided by the Navbar Flush Cache module.
 */

/**
 * Inform about additional module-specific caches that can be cleared.
 *
 * Navbar Flush Cache uses this hook to gather information about available
 ...
 */
function hook_navbar_flush_cache_info() {
  $caches['update'] = array(
    'title' => t('Update data'),
